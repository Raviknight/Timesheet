...
**Read this first.** This file is the entrypoint for any Codex (chat or Codex
...
These are the conventions Ravi and previous Codex sessions have settled on.
...
Codex in VS Code) picks up cleanly.
